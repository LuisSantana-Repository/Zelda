...
//	public static Boolean deteccionMoblin(Player Link, int life) {
//		int leftXTile = (Link.getX() + Link.getHitbox().x)/GamePanel.tileSize;
//		int rightXTile = (Link.getX() + Link.getHitbox().x +Link.getHitbox().width)/GamePanel.tileSize;
//		int upYTile = ((Link.getY() + Link.getHitbox().y)/GamePanel.tileSize)-3;
//		int downYTile =((Link.getY() + Link.getHitbox().y +Link.getHitbox().height)/GamePanel.tileSize)-3;
...
//	}
//	
	public static boolean deteccionPared(Moblin moblin) {
		int leftXTile = (moblin.getX() + moblin.getHitbox().x)/GamePanel.tileSize;
		int rightXTile = (moblin.getX() + moblin.getHitbox().x +moblin.getHitbox().width)/GamePanel.tileSize;
		int upYTile = ((moblin.getY() + moblin.getHitbox().y)/GamePanel.tileSize)-3;
		int downYTile =((moblin.getY() + moblin.getHitbox().y +moblin.getHitbox().height)/GamePanel.tileSize)-3;
		//System.out.println(leftXTile+" "+rightXTile);
		//System.out.println(upYTile+" "+downYTile);
